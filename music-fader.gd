...
func _process(delta):
	...
	# Map linear fade to exponential volume curve
	if current_stream == 1:
		stream_player_1.volume_db = lerp(-80.0, 0.0, t)
		stream_player_2.volume_db = lerp(0.0, -80.0, t)
	else:
		stream_player_1.volume_db = lerp(0.0, -80.0, t)
		stream_player_2.volume_db = lerp(-80.0, 0.0, t)
